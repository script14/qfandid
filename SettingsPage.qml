    ...
    Flickable {
        ...
        RowLayout {
            ...
            Button {
                ...
                font.pointSize: buttonSize
                font.capitalization: Font.MixedCase
                onClicked: mainStackView.push("InfoPage.qml", {"imageSource": "Assets/Images/gpl-v3-logo.svg", "title": "GPL license", "textContent": globalBackend.readText(":/Assets/Strings/COPYING"), "format": Text.PlainText})
